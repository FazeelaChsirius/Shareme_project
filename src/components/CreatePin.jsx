...
const CreatePin = ({ user }) => {
  // React useState Hooks    ush --> short key for useState hook
  ...
  const [fields, setfFields] = useState(true);
  ...
  const savePin = () => {
    if(title && about && destination && imageAsset?._id && category) {
      ...
      setTimeout(() => setfFields(false), 2000);
              ...
              <label>
                <div className='flex flex-col items-center justify-center h-full'>
                  ...
                  <p className='mt-32 text-gray-400'>
                    use high-quality JPG, PNG, SVG, GIF or TIFF less than 20 MB
                  </p>
                </div>
                <input
                  type='file'
